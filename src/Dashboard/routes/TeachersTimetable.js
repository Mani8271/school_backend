  ...
  async (req, res) => {
    try {
      ...
      const newNotification = new NotificationsModel({
        title: "New Teachers Timetable Added",
  ...
  async (req, res) => {
    try {
      ...
      const notification = new NotificationsModel({
        title: "Teachers Timetable Deleted",
        description: `Timetable with ID ${timetableId} has been deleted from the system.`,
        date: now.format("YYYY-MM-DD"),
        time: now.format("h:mm A"),
      });
