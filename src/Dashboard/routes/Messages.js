...
// ✅ Send a new message
MessagesRoute.post("/send", userAuth, async (req, res) => {
    try {
...
MessagesRoute.get("/:conversationId", userAuth, async (req, res) => {
    try {
...
// ✅ Delete a message
MessagesRoute.delete("/delete/:messageId", userAuth, async (req, res) => {
    try {
...
MessagesRoute.patch("/status/:messageId", userAuth, async (req, res) => {
    try {
        const { messageId } = req.params;
