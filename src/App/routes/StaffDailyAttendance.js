...
StaffDailyAttendanceRoute.post( "/add-staff-daily-attendance", async (req, res) => {
    try {
...
StaffDailyAttendanceRoute.patch("/update-Attendance",async (req, res) => {
    try {
...
StaffDailyAttendanceRoute.delete("/delete-Attendance",  async (req, res) => {
  try {
    const AttendanceId = req.body._id;
    // Ensure `_id` is a valid MongoDB ObjectId
...
StaffDailyAttendanceRoute.get("/search-Attendance",  async (req, res) => {
  try {
...
StaffDailyAttendanceRoute.get("/Attendance-data",  async (req, res) => {
  try {
    const GetAttendancedata = await StaffAttendanceModel.findOne(req.body);
    res.send(GetAttendancedata);
  } catch (error) {
...
StaffDailyAttendanceRoute.get("/all-Attendance-data",  async (req, res) => {
  try {
